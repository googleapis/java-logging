...
```Groovy
implementation 'com.google.cloud:google-cloud-logging:3.20.4'
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-logging/3.20.4
