...
public class GrpcLoggingRpc implements LoggingRpc {
  ...
  public GrpcLoggingRpc(final LoggingOptions options) throws IOException {
    ...
    try {
      ...
      if (options.getHost().contains("localhost")
        ...
        LoggingServiceV2SettingsBuilder settingsBuilder =
            new LoggingServiceV2SettingsBuilder(LoggingServiceV2Settings.newBuilder().build());
  ...
  private static class LoggingServiceV2SettingsBuilder extends LoggingServiceV2Settings.Builder {
    private LoggingServiceV2SettingsBuilder(LoggingServiceV2Settings settings) {
      super(settings);
    }
