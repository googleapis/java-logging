 ...
 *           <li>listBuckets(LocationName parent)
 ...
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>createBucketAsyncAsync(CreateBucketRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>createBucketAsyncOperationCallable()
 *           <li>createBucketAsyncCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>UpdateBucketAsync</td>
 ...
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>updateBucketAsyncAsync(UpdateBucketRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>updateBucketAsyncOperationCallable()
 *           <li>updateBucketAsyncCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 ...
 *           <li>listSinks(OrganizationName parent)
 ...
 *    <tr>
 *      <td>CreateLink</td>
 *      <td><p>Asynchronously creates a linked dataset in BigQuery which makes it possible
 *  to use BigQuery to read the logs stored in the log bucket. A log bucket may
 *  currently only contain one link.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>createLinkAsync(CreateLinkRequest request)
 *      </ul>
 *      <p>Methods that return long-running operations have "Async" method variants that return `OperationFuture`, which is used to track polling of the service.</p>
 *      <ul>
 *           <li>createLinkAsync(LogBucketName parent, Link link, String linkId)
 *           <li>createLinkAsync(String parent, Link link, String linkId)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>createLinkOperationCallable()
 *           <li>createLinkCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>DeleteLink</td>
 *      <td><p>Deletes a link. This will also delete the corresponding BigQuery linked
 *  dataset.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>deleteLinkAsync(DeleteLinkRequest request)
 *      </ul>
 *      <p>Methods that return long-running operations have "Async" method variants that return `OperationFuture`, which is used to track polling of the service.</p>
 *      <ul>
 *           <li>deleteLinkAsync(LinkName name)
 *           <li>deleteLinkAsync(String name)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>deleteLinkOperationCallable()
 *           <li>deleteLinkCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>ListLinks</td>
 *      <td><p>Lists links.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>listLinks(ListLinksRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>listLinks(LogBucketName parent)
 *           <li>listLinks(String parent)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>listLinksPagedCallable()
 *           <li>listLinksCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>GetLink</td>
 *      <td><p>Gets a link.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>getLink(GetLinkRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>getLink(LinkName name)
 *           <li>getLink(String name)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>getLinkCallable()
 ...
 *           <li>listExclusions(OrganizationName parent)
